...
const SUPPORTED_CHAIN_ID = [ChainId.BSC]

export const injected = new InjectedConnector({ supportedChainIds: SUPPORTED_CHAIN_ID })

const walletconnect = new WalletConnectConnector({
  rpc: {
    [ChainId.BSC]: 'https://endpoints.omniatech.io/v1/base/mainnet/public',
...
export const connectorsByName = {
  ...
  [ConnectorNames.Blocto]: async () => {
    ...
    return new BloctoConnector({ chainId: ChainId.BSC, rpc: 'https://base.publicnode.com' })
  },
