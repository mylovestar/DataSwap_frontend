...
const FarmCard: React.FC<FarmCardProps> = ({ farm, displayApr, removed, cakePrice, account }) => {
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('DATABASE', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('DATA + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'DATA'
