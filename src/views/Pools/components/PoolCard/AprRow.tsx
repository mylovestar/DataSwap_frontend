...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0, showIcon = true }) => {
  ...
  const tooltipContent = vaultKey
    ? t('APY includes compounding, APR doesn’t. This pool’s DATA is compounded automatically, so we show APY.')
  ...
  return (
    <Flex alignItems="center" justifyContent="space-between">
      ...
      <TooltipText color="white" ref={targetRef}>{vaultKey ? `${t('APY')}:` : `${t('APR')}:`}</TooltipText>
