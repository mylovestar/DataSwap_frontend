...
export const DEFAULT_META: PageMeta = {
  title: 'DataSwap',
  description:
    'The most popular AMM on BASE by user count! Earn DATA through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by DataSwap), NFTs, and more, on a platform you can trust.',
