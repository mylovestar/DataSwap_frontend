...
const bscExplorer = { name: 'BaseScan', url: 'https://basescan.org/' }
...
export const bsc: Chain = {
  ...
  rpcUrls: {
    ...
    public: 'https://endpoints.omniatech.io/v1/base/mainnet/public',
  },
  blockExplorers: {
    default: bscExplorer,
  ...
  multicall: {
    address: '0xf33b3CF2Fde830d6c38F3C5f2b44f7f31331Bd7B',
